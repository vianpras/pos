                     ...
                     <div class="d-flex flex-row ">
                        ...
                        <div class="btn-group">
                           ...
                           <div class="dropdown-menu dropdown-menu-right" role="menu">
                              ...
                              <a href="{{ route('sales.new') }}" class="dropdown-item"> <i
...
$(document).ready(function() {
   ...
   var dTable = $('#dTable').DataTable({
        ...
        ajax: {
            ...
            data: function (d) {
               d.sales_code_filter = $('input[name=sales_code_filter]').val();
               d.sales_code_project_filter = $('input[name=sales_code_project_filter]').val();
               d.sales_date_filter = $('input[name=sales_date_filter]').val();
               d.sales_status_filter = $('select[name=sales_status_filter] option').filter(':selected').val()
            }
        } ,
        columns: [
            {data: 'action', name: 'action','orderable':false,'searchable':false},
            {data: 'table', name: 'sales.table'},
            {data: 'code', name: 'sales.code'},
            {data: 'date_order', name: 'sales.date_order'},
            {data: 'customer', name: 'sales.customer'},
            {data: 'member', name: 'memberships.nama'},
            {data: 'status', name: 'sales.status','orderable':false,'searchable':true}
        ],
   });
