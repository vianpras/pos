                     ...
                     <div class="d-flex flex-row ">
                        ...
                        <div class="btn-group">
                           ...
                           <div class="dropdown-menu dropdown-menu-right" role="menu">
                              ...
                              <a href="{{ route('booking.new') }}" class="dropdown-item"> <i
                     ...
                     <div class="row">
                        <div class="col-sm-3">
                           <div class="form-group">
                              <label for="booking_code_filter">Kode Pemesanan</label>
                              <input type="text" class="form-control form-control-sm" name="booking_code_filter"
                                 id="booking_code_filter" placeholder="Filter Kode Permintaan Pembelian">
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                 ...
                                 <input type="text" class="form-control form-control-sm float-right"
                                    name="booking_date_filter" id="reservation" placeholder="Range Tanggal"
                        ...
                        <div class="col-sm-3">
                           <div class="form-group">
                              <label for="booking_status_filter">Status Pemesanan</label>
...
$(document).ready(function() {
   ...
   var dTable = $('#dTable').DataTable({
        ...
        ajax: {
            ...
            data: function (d) {
               d.booking_code_filter = $('input[name=booking_code_filter]').val();
               d.booking_code_project_filter = $('input[name=booking_code_project_filter]').val();
               d.booking_date_filter = $('input[name=booking_date_filter]').val();
               d.booking_status_filter = $('select[name=booking_status_filter] option').filter(':selected').val()
            }
        } ,
        columns: [
            {data: 'action', name: 'action','orderable':false,'searchable':false},
            {data: 'code', name: 'bookings.code'},
            {data: 'date_booking', name: 'bookings.date_booking'},
            {data: 'name', name: 'bookings.name'},
            {data: 'member', name: 'memberships.nama'},
            {data: 'mobile', name: 'bookings.mobile'},
            {data: 'status', name: 'bookings.status','orderable':false,'searchable':true}
        ],
   });
