...
<div class="content-wrapper">
   ...
   <section class="content">
      <form method="POST" action="{{ route('booking.update', $data->code) }}">
         @csrf
         <div class="card">
            ...
            <div class="card-header">
               <h3 class="card-title">
                  {{ $title ?? '' }}
                  <span class="text-bold">#{{$data->code}}
                  </span>
               </h3>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <select class="form-control form-control-sm select2" style="width: 100%;"
                                          ...
                                          <option value='pending' @if($data->status === 'pending') selected @endif
                                             class="text-capitalize">Pending</option>
                                          <option value='confirm' @if($data->status === 'confirm') selected @endif
                                             class="text-capitalize">Confirm</option>
                                          <option value='cancel' @if($data->status === 'cancel') selected @endif
                                             class="text-capitalize">Cancel</option>
                                          <option value='close' @if($data->status === 'close') selected @endif
                                             class="text-capitalize">Close</option>
                                       </select>
                                    </div>
                                 </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <select class="form-control form-control-sm selectMember" id="membership_code"
                                          ...
                                          <option value="membership_code">{{$data->name.' | '.$data->mobile}}</option>
                                       </select>
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control form-control-sm text-uppercase"
                                          name="member_id" id="member_id" placeholder="ID Anggota"
                                          value="{{$data->membership_code}}" autofocus required>
                                    </div>
                                 </div>
                                       ...
                                       <div class="form-group" data-target="#dateSelect" data-toggle="datetimepicker">
                                          <div class="input-group date" id="dateSelect" data-target-input="nearest">
                                             ...
                                             <input type="text"
                                                ...
                                                data-target="#dateSelect" min="{{ Date('Y-m-d') }}"
                                                value="{{ $data->date_booking }}" name="date_need" on readonly
                                                required />
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control form-control-sm" name="name" id="name"
                                          placeholder="Nama Pemesan" value="{{$data->name}}">
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control form-control-sm" name="mobile" id="mobile"
                                          placeholder="No. HP Pemesan" value="{{$data->mobile}}">
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group" id="necessary_div">
                                       ...
                                       <textarea class="form-control" id="necessary" name="necessary" rows="4"
                                          placeholder="Catatan ..." required>{!!$data->necessary!!}</textarea>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <table class="table table-sm table-hover table-responsive-sm">
                              ...
                              <tbody>
                                 ...
                                 <tr id="{{$key}}">
                                    <td>
                                       ...
                                       <input type="hidden" name="booking_detail_id[{{$key}}]" value="{{$item->id}}">
                                    </td>
                                    <td>
                                       <select class="form-control form-control-sm selectItem" name="nama[{{$key}}]"
                                          placeholder="Nama Item" id="nama_{{$key}}" autocomplete="off" required>
                                          <option value="{{$item->item_id}}">{{$item->code.' | '.$item->name}}</option>

                                       </select>
                                    </td>
                                    <td>
                                       <input type="number" class="form-control form-control-sm"
                                          name="quantity[{{$key}}]" id="quantity_{{$key}}" placeholder="Qty"
                                          onkeypress="calcSum({{$key}})" onkeyup="calcSum({{$key}})" min=0
                                          ondrop="return false;" onpaste="return false;" autocomplete="off"
                                          value="{{$item->quantity}}" required>
                                    </td>
                                    <td>
                                       <input type="text" class="form-control form-control-sm uang"
                                          name="sell_price[{{$key}}]" id="sell_price_{{$key}}" placeholder="Harga" min=0
                                          ondrop="return false;" onpaste="return false;" autocomplete="off" readonly
                                          value="{{$item->sell_price}}" required>
                                    </td>
                                    <td>
                                       <input type="text" class="form-control form-control-sm uang"
                                          name="sub_total[{{$key}}]" id="sub_total_{{$key}}" placeholder="Jumlah"
                                          onkeyup="goToFirst(0);" min=0 ondrop="return false;" onpaste="return false;"
                                          autocomplete="off" readonly value="{{$item->sub_total}}" required>
                                    </td>
                              ...
                              <tfoot>
                                 <tr>
                                    ...
                                    <td>
                                       <input type="text" class="form-control form-control-sm uang"
                                          name="sub_grand_total" id="sub_grand_total" value="{{$data->sub_total}}"
                                          placeholder="Sub Total" min=0 ondrop="return false;" onpaste="return false;"
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <input type="number" class="form-control form-control-sm" name="tax" id="tax"
                                          ...
                                          value="{{$data->tax}}" step="0.01" placeholder="Pajak" min="0" max="50"
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <input type="text" class="form-control form-control-sm uang" name="total"
                                          id="total" value="{{$data->total}}" placeholder="Total" min=0
                                          ondrop="return false;" onpaste="return false;" autocomplete="off" readonly
                                          required>
                                    </td>
                                 </tr>
...
<script>
   ...
   const _addTr = (i) =>{
      html = '<tr id="'+i+'">';
      html += '<td><input type="checkbox" class="cBox"><input type="hidden" name="counting" value="'+i+'" autocomplete="off"><input type="hidden" name="booking_detail_id['+i+']"></td>';
