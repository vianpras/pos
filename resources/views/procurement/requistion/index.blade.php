                     ...
                     <div class="d-flex flex-row ">
                        ...
                        <div class="btn-group">
                           ...
                           <div class="dropdown-menu dropdown-menu-right" role="menu">
                              ...
                              <a href="{{ route('requistion.new') }}" class="dropdown-item"> <i
                     ...
                     <div class="row">
                        <div class="col-sm-3">
                           <div class="form-group">
                              <label for="requistion_code_filter">Kode Permintaan Pembelian</label>
                              <input type="text" class="form-control form-control-sm" name="requistion_code_filter"
                                 id="name" placeholder="Filter Kode Permintaan Pembelian">
                           </div>
                        </div>
                        {{-- <div class="col-sm-3">
                           <div class="form-group">
                              <label for="requistion_code_project_filter"> Kode Proyek</label>
                              <input type="text" class="form-control form-control-sm" name="user_mail_filter" id="email"
                                 placeholder="Filter Kode Proyek">
                           </div>
                        </div> --}}
                        <div class="col-sm-3">
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                 ...
                                 <input type="text" class="form-control form-control-sm float-right"
                                    name="requistion_date_filter" id="reservation" placeholder="Range Tanggal"
                        ...
                        <div class="col-sm-3">
                           <div class="form-group">
                              <label for="requistion_status_filter">Status</label>
                              <select class="form-control form-control-sm select2" style="width: 100%;"
                                 name="requistion_status_filter">
...
$(document).ready(function() {
   ...
   var dTable = $('#dTable').DataTable({
        ...
        ajax: {
            url: '{{ route("requistion.datatable") }}',
            'type': 'POST',
            headers: {
                  'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            data: function (d) {
               d.requistion_code_filter = $('input[name=requistion_code_filter]').val();
               d.requistion_code_project_filter = $('input[name=requistion_code_project_filter]').val();
               d.requistion_date_filter = $('input[name=requistion_date_filter]').val();
               d.requistion_status_filter = $('select[name=requistion_status_filter] option').filter(':selected').val()
            }
        } ,
        columns: [
            {data: 'action', name: 'action','orderable':false,'searchable':false},
            {data: 'code', name: 'requistions.code'},
            {data: 'date_request', name: 'requistions.date_request'},
            {data: 'project_code', name: 'projects.code'},
            {data: 'name', name: 'users.name'},
            {data: 'status', name: 'requistions.status','orderable':false,'searchable':false}
        ],
   });
