<center>
   ...
   <button type="button" id="editButton" class="btn btn-outline-info btn-xs" data-toggle="modal" data-id="{{ $prefix }}" data-attr="{{ route('docPrefix.edit', $prefix) }}" data-target="#modalBlade">
      <i class="fas fa-edit"></i>
   </button>
   @endif
   {{-- @if(Helper::checkACL('master_unit', 'd'))
   <a href="javascript:void(0);" id="_bDelete" data-toggle="tooltip" data-original-title="Delete" data-id="{{ $prefix }}"
