                           ...
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                 ...
                                 <input type="text" class="form-control form-control-sm float-right"
                                    name="unit_date_filter" id="reservation" placeholder="Range Tanggal"
...
<script>
   ...
   $(document).on('click', '#saveButton', function (event) {
      ...
      $.ajax({
         url: "/dataInduk/docPrefix/store/",
         method: "POST",
         data: {
            docType: $("form#formNew #docType").val(),
            prefix: $("form#formNew #prefix").val(),
         },
         // return the result
         success: function (result) {
   ...
   $(document).on('click', '#updateButton', function (event) {
      ...
      $.ajax({
         url: "/dataInduk/docPrefix/update/" + _id,
         method: "POST",
         data: {
            docType: $("form#formUpdate #docType").val(),
            prefix: $("form#formUpdate #prefix").val(),
         },
         // return the result
         success: function (result) {
            var oTable = $('#dTable').dataTable();
