                     ...
                     <div class="row">
                        <div class="col-sm-3">
                           <div class="form-group">
                              <label for="user_name_filter">Nama</label>
                              <input type="text" class="form-control form-control-sm" name="user_name_filter" id="name"
                                 placeholder="Filter Nama">
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group">
                              <label for="user_email_filter">Email</label>
                           ...
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                 ...
                                 <input type="text" class="form-control form-control-sm float-right"
                                    name="user_date_filter" id="reservation" placeholder="Range Tanggal"
...
<script>
   ...
   $(document).ready(function () {
      ...
      var dTable = $('#dTable').DataTable({
         ...
         ajax: {
            url: '{{ route("pengguna.datatable") }}',
            'type': 'POST',
            headers: {
               'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            data: function (d) {
               d.user_name_filter = $('input[name=user_name_filter]').val();
               d.user_mail_filter = $('input[name=user_mail_filter]').val();
               d.user_date_filter = $('input[name=user_date_filter]').val();
               d.user_status_filter = $('select[name=user_status_filter] option').filter(':selected').val()
            }
         },
         columns: [
            ...
            {data: 'hakakses', name: 'users_acls.name'},
...
<script>
   ...
   $(document).on('click', '#saveButton', function (event) {
      ...
      $.ajax({
         url: "/dataInduk/pengguna/store/",
         method: "POST",
         data: {
            name: $("form#formNew #name").val(),
            username: $("form#formNew #username").val(),
            email: $("form#formNew #email").val(),
            mobile: $("form#formNew #mobile").val(),
            password: $("form#formNew #password").val(),
            password_confirmation: $("form#formNew #password_confirmation").val(),
            status: $("form#formNew #status").val(),
            users_acls_id: $("form#formNew #users_acls_id").val(),
            sudo: $("form#formNew #sudo").val(),
         },
         // return the result
         success: function (result) {
   ...
   $(document).on('click', '#updateButton', function (event) {
      ...
      $.ajax({
         url: "/dataInduk/pengguna/update/" + _id,
         method: "POST",
         data: {
            name: $("form#formUpdate #name").val(),
            username: $("form#formUpdate #username").val(),
            email: $("form#formUpdate #email").val(),
            mobile: $("form#formUpdate #mobile").val(),
            status: $("form#formUpdate #status").val(),
            users_acls_id: $("form#formUpdate #users_acls_id").val(),
            sudo: $("form#formUpdate #sudo").val(),
         },
         // return the result
         success: function (result) {
            var oTable = $('#dTable').dataTable();
