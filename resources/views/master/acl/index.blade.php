         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Data hakakses</li>
               </ol>
            </div>
         </div>
      </div>
                        ...
                        <div class="d-flex flex-row justify-content-end">
                           ...
                           <div class="btn-group">
                              ...
                              <div class="dropdown-menu dropdown-menu-right" role="menu">
                                 ...
                                 @endif
                                 @if(Helper::checkACL('master_acl', 'i'))
                     ...
                     <div class="row">
                        <div class="col-sm-3">
                           <div class="form-group">
                              <label for="acl_name_filter">Nama Hak Akses</label>
                              <input type="text" class="form-control form-control-sm" name="acl_name_filter" id="name"
         ...
         <div class="modal-dialog modal-lg role=" document">
            <div class="modal-content">
               {{-- <div class="modal-header">
                  <h5 class="modal-title">Ubah Data</h5><br>
...
<script>
   ...
   $(document).ready(function () {
      ...
      var dTable = $('#dTable').DataTable({
         ...
         ajax: {
            url: '{{ route("acl.datatable") }}',
            'type': 'POST',
            headers: {
               'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            data: function (d) {
               d.acl_name_filter = $('input[name=acl_name_filter]').val();
            }
         },
         columns: [
...
<script>
   ...
   $(document).on('click', '#saveButton', function (event) {
      event.preventDefault();
      //get id & value dynamic form hakakses
      const form = document.getElementById('formNew');
      let _data = {}
      let name = {_name: $("form#formNew #name").val()}
      const _loop = [...form.elements].forEach(item => {

         const _value = $('#' + item.id).prop("checked") ? 1 : 0
         const _item = (!!item.id) && {[item.id]: _value}
         _data = {...name, ..._item, ..._data}
      });
      $.ajaxSetup({
         headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
   ...
   $(document).on('click', '#updateButton', function (event) {
      ...
      let _data = {}
      let name = {_name: $("form#formUpdate #name").val()}
      const _loop = [...form.elements].forEach(item => {
