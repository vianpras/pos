            ...
            <div class="card">
               ...
               <div class="card-footer filterCard">
                  <div class="float-right ">
                     <button type="button" class="btn btn-sm bg-olive my-2"><i class="fas fa-file-excel"></i> &nbsp;Export</button>&nbsp;
                     <button type="button" class="btn btn-info btn-sm" id="filterButton"><i class="fab fa-searchengin"></i> &nbsp;Filter</button>
                  </div>
               </div>
         ...
         <div class="col-12 m-1">
            <div class="card" id="chartReport" style="display:none">
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-12">
                        <p class="text-center">
                           <strong class="text-secondary" id="datePurchaseChart"></strong>
                        </p>
                        <div class="chart" id="chartDiv">
                           <canvas id="purchaseChart" height="300" style="height: 250px;"></canvas>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-sm-4 col-6">
                        <div class="description-block border-right">
                           {{-- <span class="description-percentage text-success"><i class="fas fa-caret-up"></i>
                              17%</span> --}}
                           <h4 class="description-header text-teal" id="totalPurchaseChart">Rp. 0</h4>
                           <span class="description-text">PEMBELIAN</span>
                        </div>
                        <!-- /.description-block -->
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-4 col-6">
                        <div class="description-block border-right">
                           {{-- <span class="description-percentage text-warning"><i class="fas fa-caret-left"></i>
                              0%</span> --}}
                           <h4 class="description-header text-orange" id="transactionPurchaseChart">0 Nota</h4>
                     ...
                     <div class="col-sm-4 col-6">
                        <div class="description-block">
                           {{-- <span class="description-percentage text-success"><i class="fas fa-caret-up"></i>
                              20%</span> --}}
                           <h4 class="description-header text-info" id="itemPurchaseChart">0 Item</h4>
            ...
            <div class="card" id="resultReportGlobal" style="display: none">
               <div class="card-footer">
                  <span class="h5 text-secondary float-left">LAPORAN PEMBELIAN GLOBAL</span>
                  <div class="float-right">
                     <span class="h5 text-secondary text-bold text-teal" id="tittleTotalPurchase"></span>
                     <span class="h5 text-secondary text-bold text-teal" id="totalPurchase"></span>
                  </div>
               </div>
               <div class="card-body" id="errorMessage"></div>
               {{-- jenis report global --}}
               <div class="card-body">
                  <table class="table table-hover text-nowrap table-head-fixed" id="tReportItem">
                     <thead>
                        <tr>
                           <th>NOTA</th>
                           <th>TANGGAL</th>
            ...
            <div class="card" id="resultReportItem" style="display: none">
               <div class="card-footer">
                  <span class="h5 text-secondary float-left">LAPORAN PEMBELIAN ITEM</span>
                  <div class="float-right">
                     <span class="h5 text-secondary text-bold text-teal" id="tittleTotalPurchaseItem"></span>
                     <span class="h5 text-secondary text-bold text-teal" id="totalPurchaseItem"></span>
                  </div>
               </div>
               <div class="card-body">
            ...
            success: function (result) {
               if (result.status == "success") {
                  ...
                  if (typeReport == 0) {
                     ...
                     if (showChart == 1) {
                        // hapus canvas
                        canvasDestroy('#chartDiv','purchaseChart');
                        ...
                        $("#datePurchaseChart").text(chart.datePurchaseChart);
                        maskRupiah("#totalPurchaseChart", chart.totalPurchaseChart);
                        $("#transactionPurchaseChart").text(
                           formatNumber(chart.transactionPurchaseChart) + " Nota"
                        );
                        $("#itemPurchaseChart").text(
                           formatNumber(chart.itemPurchaseChart) + " Item"
                        );
                        chartLine("#purchaseChart", chart.label, datasets, true);
                     }
                     // tampilkan card
                     ...
                     reports.forEach((report) => {
                        ...
                        htmlResultReport = "<tr>";
                        htmlResultReport += "<td>" + report.kode_pembelian + "</td>";
                        htmlResultReport += "<td>" + report.tanggal + "</td>";
                        htmlResultReport += "<td>" + maskRupiah("", report.total) + "</td>";
                        htmlResultReport += "</tr>";
                        tResultReportGlobal.append(htmlResultReport);
                        $("#tittleTotalPurchase").text(
                           // "TOTAL PEMBELIAN [ " + report.count_sales + " Nota ] : "
                           "TOTAL PEMBELIAN : "
                        );
                        maskRupiah("#totalPurchase", report.total_purchases);
                     });
                  ...
                  if (typeReport == 1) {
                     ...
                     if (showChart == 1) {
                        ...
                        $("#datePurchaseChart").text(chart.datePurchaseChart);
                        $('#footerReport').hide()
                        chartLine("#purchaseChart", chart.label, datasets, false);
                     }
                     ...
                     reports.forEach((report) => {
                        ...
                        $("#tittleTotalPurchaseItem").text(
                           // "TOTAL PEMBELIAN ITEM [ " + report.count_sales + " Nota ] : "
                           "TOTAL PEMBELIAN ITEM: "
                        );
                        // console.log(chart.itemPurchaseChart)
                        $("#totalPurchaseItem").text(formatNumber(chart.itemPurchaseChart));
                     });
                  }
               }
