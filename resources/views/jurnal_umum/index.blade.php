...
<script>
    var dTable = $('#dTable').DataTable({
        ...
        ajax: {
            url: "{{ url('jurnal') }}",
            data: function (d) {
                d.nomor_jurnal = $('#nomor_jurnal_filter').val(),
                d.nomor_transaksi = $('#nomor_transaksi_filter').val(),
                d.date = $('#reservation').val()
            }
        },
        columns: [
            {data: 'link_jurnal', name: 'nomor_dokumen'},
            {data: 'no_transaksi', name: 'nomor_dokumen'},
            {data: 'tgl_transaksi', name: 'tgl_transaksi'},
            {data: 'tipe', name: 'tgl_transaksi'},
