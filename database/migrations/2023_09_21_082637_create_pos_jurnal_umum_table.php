...
class CreatePosJurnalUmumTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pos_jurnal_umum', function (Blueprint $table) {
            $table->id();
            $table->string('no_jurnal_umum', 100);
    ...
    {
        Schema::dropIfExists('pos_jurnal_umum');
    }
}
